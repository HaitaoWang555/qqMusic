...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__search_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__toplist_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recommend_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__music_player_js__ = __webpack_require__(8);





let search = new __WEBPACK_IMPORTED_MODULE_0__search_js__["a" /* Search */](document.querySelector("#search-view"));
let player = new __WEBPACK_IMPORTED_MODULE_3__music_player_js__["a" /* MusicPlayer */](document.querySelector("#player"));
let toplist = new __WEBPACK_IMPORTED_MODULE_1__toplist_js__["a" /* TopList */](document.querySelector("#rank-view")).launch();
let recommend = new __WEBPACK_IMPORTED_MODULE_2__recommend_js__["a" /* Recommend */](document.querySelector("#rec-view")).launch();
...
class Search {
  ...
  search(keyword, page) {
    ...
    this.loading()
    fetch(Object(__WEBPACK_IMPORTED_MODULE_1__helpers_js__["c" /* searchUrl */])(this.keyword, page || this.page))
      .then(res => res.json())
      .then(json => {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lazyload_js__ = __webpack_require__(2);
...
class TopList {
  ...
  render() {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__lazyload_js__["a" /* lazyload */])(document.querySelectorAll("#rank-view .toplist .lazyload"));
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lazyload_js__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_js__ = __webpack_require__(1);
...
class MusicPlayer {
  constructor(el) {
    ...
    this.lyrics = new __WEBPACK_IMPORTED_MODULE_1__lyrics_player_js__["a" /* LyricsPlayer */](
  ...
  play(options = {}) {
    ...
    if (options.songid) {
      ...
      this.$audio.src = Object(__WEBPACK_IMPORTED_MODULE_2__helpers_js__["d" /* songUrl */])(this.songmid);
      this.fetching = true;
